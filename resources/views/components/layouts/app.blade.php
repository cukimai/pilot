...
<body class="min-h-screen bg-white text-gray-900 antialiased">
    ...
    <script>
        ...
        const vapiToken = "feaf70be-7b43-42d4-b4fd-8cc013b059a2";
        const assistantId = "ae1fb1db-b24f-441a-a0ba-4c6bd17a740c";

        function startVapiCall() {
            const btn = document.getElementById('vapi-call-btn');
            if (vapiInstance && vapiInstance.started) {
                vapiInstance.stop();
            ...
            if (!vapiInstance) {
                ...
                vapiInstance.on('call-start', () => {
                    ...
                    vapiInstance.started = true;
                });
                vapiInstance.on('call-end', () => {
                    btn.innerHTML = '<svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" /></svg>';
                    btn.classList.remove('bg-red-500');
                    btn.classList.add('bg-green-500');
                    vapiInstance.started = false;
                });
            }
    ...
    <script defer src="https://cdn.jsdelivr.net/gh/VapiAI/html-script-tag@latest/dist/assets/index.js"></script>
</body>
</html>
